...
public class graph_frag extends Fragment implements View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        Toast.makeText(getActivity(),Receivedreading[0], Toast.LENGTH_LONG).show();
        Toast.makeText(getActivity(),Receivedreading[1], Toast.LENGTH_LONG).show();
        Toast.makeText(getActivity(),Receivedreading[2], Toast.LENGTH_LONG).show();
        double step ;
